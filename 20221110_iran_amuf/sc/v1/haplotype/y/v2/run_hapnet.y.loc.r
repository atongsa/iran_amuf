...
# cd
setwd('/public/home/d0202110815/at42/proj/iran_amuf/hap_net/chr_y')
...
loc_spe <- 'sam_ple/ram.hap.strata'
...
write_tsv(hap_tsv, "popart_loc/hap_net.tsv", col_names = T)
