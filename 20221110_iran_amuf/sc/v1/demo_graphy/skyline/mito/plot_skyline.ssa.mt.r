...
# tsv
```sh
cd /public/home/d0202110815/at42/proj/iran_amuf/demo_graphy/chr_mito/plot

for f in {abd,ce,o.HCE}.tsv
do
g_p=${f%.tsv}
...
# wd
setwd("/public/home/d0202110815/at42/proj/iran_amuf/demo_graphy/chr_mito/plot")
...
p <- ggplot(df_n) +
	...
	labs(x=expression("KYears (mitochondria, µ=2.1x"*10^-8*")"),
