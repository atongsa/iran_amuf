...
# args
w_d <- '/public/home/d0202110815/at42/proj/iran_amuf/d_stats/s_dinves/d.inves_filter/plot'
...
df_n <- df %>%
	...
	mutate(GAR=ifelse(X4==1, rg_lb, NA)) %>%
	mutate(GUR=ifelse(X5==1, rg_lb, NA)) %>%
