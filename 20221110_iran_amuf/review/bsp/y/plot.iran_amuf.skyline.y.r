...
# tsv
```sh
cd /home/atongsa/Documents/projects/papers/20221110_iran_amuf/ana/review/ana/bsp/plot_y/og
...
p <- ggplot(df_n) +
	...
	labs(x=expression("KYears (Y_snp, µ=6.45x"*10^-8*")"),
