...
# tsv
```sh
cd /home/atongsa/Documents/projects/papers/20221110_iran_amuf/ana/review/ana/bsp/plot_mt

for f in {habd,hce,o.HCE}.tsv
do
g_p=${f%.tsv}
sed '1,2 d' $f | awk -vg_p=$g_p 'BEGIN{OFS="\t"}{print g_p,$0}'
done > mt.all.tsv # 1,3,4,5,6

```

# wd
setwd("/public/home/d0202110815/at42/proj/iran_amuf/review/bsp/plot")
...
p <- ggplot(df_n) +
	...
	labs(x=expression("KYears (mitochondria, µ=9.44x"*10^-9*")"),
