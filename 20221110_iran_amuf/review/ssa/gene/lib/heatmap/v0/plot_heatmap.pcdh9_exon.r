...
# wd
setwd('/public/home/d0202110815/at42/proj/iran_amuf/gene/hapnet/fa_pcdh9_exon')

# args
df_f <- 'vf.tsv'

pop_f <- 'hap.og_new.strata'
pop_level <- 'id.lv'
...
# save
# op_n <- 'ht.pcdh9_exon.pdf'
#
# pdf(op_n, width = 7, height = 7, family = "Arial")
# draw(ht2, padding = unit(c(6, 12, 6, 12), "mm"), annotation_legend_side = "top", legend_grouping = "original") # t/l/b/r
# dev.off()
...
pdf(op_n, width = 7, height = 7, family = "Arial")
draw(ht + ht2, padding = unit(c(6, 12, 6, 12), "mm"), annotation_legend_side = "top", legend_grouping = "original") # t/l/b/r
dev.off()
