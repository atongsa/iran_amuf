...
# args
w_d <- '/public/home/d0202110815/at42/proj/iran_amuf/review/ssa/gene/dxy_fst/plot'
...
p <- ggplot(df_n, aes(x=chr_position, y=value,
    color=pop2)) +
    ...
    scale_y_continuous(breaks=c(0,0.2,0.4,0.6,0.8), labels = c("0","0.2","0.4","0.6", "0.8"), expand = c(0, 0)) +
    scale_color_manual(values=mypal)
    # limits = c(0,1),
    # scale_color_brewer(palette = "Set1")

# anno; 41104271-41313804
p1 <- p +
    #theme(panel.border = element_rect(colour = "black", fill=NA, linewidth =1)) +
	annotate("rect", xmin=41205, xmax=41212, ymin=0, ymax=0.7,
